...
import 'package:checkpoint_app2/components/static_map_widget.dart';
...
class TrackScreen extends GetView<UserController> {
  ...
  Widget build(BuildContext context) {
    ...
    if (controller.trackScreenLoaded.value == false) {
      controller.trackScreenLoaded.toggle();
    }
            ...
            Obx(() {
              if (controller.isLoggedIn.value == true) {
                return Positioned(
                  left: 0,
                  bottom: 0,
                  child: controller.trackScreenLoaded.value == false
                      ? Spring.slide(
